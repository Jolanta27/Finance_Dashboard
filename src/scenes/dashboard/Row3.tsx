...
const Row3 = () => {
  ...
  return (
   ...
   {pieChartData?.map((data, i) => (
    ...
    <BoxHeader title="Overall Summary and Explonation Data" sideText="+15%" />
    <Box
    height="15px"
    ...
    <Typography margin="0 1rem" variant="h6">
              Thank you for your continued support. We are here to provide you with the best service and support.
    </Typography>
    </DashboardBox>
    </>
  )
